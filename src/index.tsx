...
// the default export is the same documented AgGridSolid symbol (re-export aliases carry no
// JSDoc of their own in deno_doc; JSR resolves the reference to the documented target)
